...
const translations: Record<Language, Record<string, any>> = {
  en: {
    ...
    contact: {
      ...
      heroSubtitle: "Our team of security experts is ready to help you protect your enterprise. Reach out to schedule a consultation.",
      getInTouch: "Get in Touch",
      getInTouchDesc: "Whether you need a security assessment, compliance guidance, or want to learn more about our services, we're here to help.",
      emailLabel: "Email",
      phoneLabel: "Phone",
      ...
      messageReceivedDesc: "Thank you for reaching out. One of our security consultants will contact you within 24 business hours.",
    ...
    about: {
      ...
      heroSubtitle: "Founded by security veterans with decades of combined experience, Red Patronus has grown into a trusted partner for enterprise organizations seeking comprehensive offensive security services.",
      mission: {
        title: "Our Mission",
      ...
      values: {
        integrity: { title: "Integrity", description: "We operate with the highest ethical standards, ensuring client trust and confidentiality in all engagements." },
        excellence: { title: "Excellence", description: "Our team pursues continuous improvement, staying ahead of emerging threats and attack techniques." },
        collaboration: { title: "Collaboration", description: "We work as an extension of your team, fostering partnerships that drive lasting security improvements." },
        confidentiality: { title: "Confidentiality", description: "Client data and findings are protected with enterprise-grade security and strict access controls." },
      },
      teamTitle: "World-Class Security Team",
      teamDesc: "Our team comprises security professionals with backgrounds in enterprise security, government agencies, and leading technology companies. Every consultant holds multiple industry certifications and brings real-world experience to every engagement.",
    ...
    caseStudies: {
      ...
      heroSubtitle: "Discover how we've helped leading organizations across industries identify vulnerabilities, achieve compliance, and strengthen their security posture.",
      stats: {
        clients: "Enterprise Clients",
      ...
      certificationsSubtitle: "Our team holds industry-leading certifications and maintains partnerships with major security organizations.",
      certifications: {
    ...
    servicesPage: {
      ...
      heroSubtitle: "We deliver expert digital solutions by the book of DORA (Digital Operational Resilience Act) compliance. From vulnerability assessments to advanced threat monitoring, all our services are designed to meet the highest regulatory standards.",
      keyCapabilities: "Key Capabilities",
      securingCloud: "Securing Your Cloud on",
      customTitle: "Need a Custom Solution?",
      customSubtitle: "Our team can tailor our services to meet your organization's specific security requirements and compliance needs.",
      customButton: "Contact Our Team",
      items: {
        offensive: {
          title: "Offensive Security Services",
          description: "From classic penetration tests & customized phishing campaigns to RedTeam engagements. Our expert team simulates real-world cyber attacks to identify vulnerabilities and test your defenses.",
          features: [
        ...
        cloud: {
          title: "Cloud Security",
          description: "Specialized security assessments for AWS, Azure, and GCP environments, ensuring your cloud infrastructure meets enterprise security standards and best practices.",
          features: [
        ...
        defensive: {
          ...
          description: "Comprehensive defensive security with continuous monitoring, DevSecOps, asset management, and proactive threat response to safeguard your organization.",
          features: [
        ...
        etsm: {
          ...
          description: "OSINT-powered monitoring that uncovers vulnerabilities and delivers actionable insights through continuous surveillance of publicly available data.",
          features: [
        ...
        training: {
          ...
          description: "Equips employees with the skills to detect, report, and respond to cyber threats, ensuring compliance and protecting company assets.",
          features: [
            "Compliance Training",
        ...
        compliance: {
          ...
          description: "DORA-aligned compliance assessments, OSINT analysis, and GAP analysis following CIS, NIST, and EU regulations to ensure your organization meets all operational resilience requirements.",
          features: [
            "DORA Compliance",
            "CIS & NIST Alignment",
        ...
        iam: {
          ...
          description: "IAM as a Service using Okta, managed via Terraform and CI/CD for secure, efficient identity and access management across your organization.",
          features: [
            "Okta SSO Platform",
        ...
        phishing: {
          ...
          description: "Test employee awareness with realistic phishing simulations to reduce risks and strengthen your cybersecurity culture.",
          features: [
        ...
        siem: {
          ...
          description: "Real-time monitoring of security events with comprehensive log analysis and rapid detection and response to potential security incidents.",
          features: [
            "Real-time Monitoring",
  ...
  sk: {
    ...
    contact: {
      ...
      heroSubtitle: "Náš tím bezpečnostných expertov je pripravený pomôcť vám chrániť váš podnik. Kontaktujte nás a naplánujte konzultáciu.",
      getInTouch: "Spojte sa s nami",
      getInTouchDesc: "Či už potrebujete bezpečnostné hodnotenie, poradenstvo v oblasti súladu alebo chcete vedieť viac o našich službách, sme tu pre vás.",
      emailLabel: "Email",
      phoneLabel: "Telefón",
      locationLabel: "Sídlo",
      ...
      messageReceivedDesc: "Ďakujeme za kontaktovanie. Jeden z našich bezpečnostných konzultantov vás bude kontaktovať do 24 pracovných hodín.",
      sendAnother: "Odoslať ďalšiu správu",
      privacyNote: "Odoslaním tohto formulára súhlasíte s našimi zásadami ochrany osobných údajov. Vaše informácie nikdy nebudeme zdieľať.",
      form: {
        name: "Celé meno",
    ...
    about: {
      ...
      heroSubtitle: "Založená bezpečnostnými veteránmi s desaťročiami kombinovaných skúseností, Red Patronus sa rozrástla na dôveryhodného partnera pre podnikové organizácie hľadajúce komplexné ofenzívne bezpečnostné služby.",
      mission: {
        title: "Naša misia",
      ...
      values: {
        integrity: { title: "Integrita", description: "Pracujeme s najvyššími etickými štandardmi, zabezpečujúc dôveru klientov a dôvernosť vo všetkých zákazkách." },
        excellence: { title: "Excelentnosť", description: "Náš tím sa neustále zdokonaľuje, držiac krok s novými hrozbami a útočnými technikami." },
        collaboration: { title: "Spolupráca", description: "Pracujeme ako rozšírenie vášho tímu, podporujúc partnerstvá, ktoré prinášajú trvalé bezpečnostné zlepšenia." },
        confidentiality: { title: "Dôvernosť", description: "Údaje klientov a zistenia sú chránené podnikovou úrovňou zabezpečenia a prísnymi kontrolami prístupu." },
      },
      teamTitle: "Bezpečnostný tím svetovej triedy",
      teamDesc: "Náš tím tvoria bezpečnostní profesionáli so skúsenosťami z podnikovej bezpečnosti, vládnych agentúr a popredných technologických spoločností. Každý konzultant má viacero certifikácií a prináša reálne skúsenosti do každej zákazky.",
      ...
      ctaSubtitle: "Poďme diskutovať o tom, ako môže Red Patronus pomôcť posilniť bezpečnostnú pozíciu vašej organizácie.",
      ctaButton: "Kontaktujte nás ešte dnes",
    },
    caseStudies: {
      heroLabel: "Prípadové štúdie",
      heroTitle: "Preukázané výsledky pre podnikových klientov",
      heroSubtitle: "Zistite, ako sme pomohli popredným organizáciám naprieč odvetviami identifikovať zraniteľnosti, dosiahnuť súlad a posilniť ich bezpečnostnú pozíciu.",
      stats: {
        clients: "Podnikoví klienti",
      ...
      studies: {
        financial: {
          ...
          challenge: "Veľká globálna banka potrebovala komplexné bezpečnostné hodnotenie naprieč 200+ aplikáciami pred veľkou iniciatívou digitálnej transformácie.",
          solution: "Realizovali sme fázovaný program penetračného testovania, red team zákazku a revíziu bezpečnostnej architektúry počas 12 mesiacov.",
          results: [
        ...
        healthcare: {
          ...
          challenge: "Regionálny poskytovateľ zdravotnej starostlivosti s 15 nemocnicami potreboval posúdiť bezpečnostnú pozíciu a dosiahnuť súlad s HIPAA.",
          solution: "Vykonali sme sieťové penetračné testovanie, hodnotenie bezpečnosti aplikácií a analýzu medzier v súlade naprieč všetkými zariadeniami.",
          results: [
        ...
        technology: {
          ...
          challenge: "Podniková SaaS spoločnosť pripravujúca sa na IPO vyžadovala validáciu bezpečnosti treťou stranou a SOC 2 certifikáciu.",
          solution: "Komplexný bezpečnostný program vrátane hodnotenia cloudovej bezpečnosti, testovania API a nepretržitého penetračného testovania.",
          results: [
      ...
      testimonials: {
        t1: {
          quote: "Red Patronus transformoval našu bezpečnostnú pozíciu. Odbornosť a profesionalita ich tímu prekonala naše očakávania v každej fáze.",
          author: "Riaditeľ informačnej bezpečnosti",
          company: "Popredná spoločnosť finančných služieb",
        },
        t2: {
          quote: "Hĺbka ich hodnotení nám dala istotu, že sme boli skutočne pripravení na reálne hrozby. Výnimočná práca.",
          author: "VP inžinieringu",
          company: "Podniková technologická spoločnosť",
        },
      },
      certificationsTitle: "Certifikácie a partnerstvá v odvetví",
      certificationsSubtitle: "Náš tím má popredné certifikácie v odvetví a udržiava partnerstvá s hlavnými bezpečnostnými organizáciami.",
      certifications: {
      ...
      ctaSubtitle: "Kontaktujte nás a prediskutujte, ako vám môžeme pomôcť posilniť bezpečnostnú pozíciu vašej organizácie.",
      ctaButton: "Začať hodnotenie",
    },
    servicesPage: {
      heroLabel: "Naše služby",
      heroTitle: "Podnikové bezpečnostné riešenia",
      heroSubtitle: "Poskytujeme odborné digitálne riešenia podľa zákona DORA (Zákon o digitálnej prevádzkovej odolnosti). Od hodnotenia zraniteľností po pokročilé monitorovanie hrozieb, všetky naše služby sú navrhnuté tak, aby spĺňali najvyššie regulačné štandardy.",
      keyCapabilities: "Kľúčové schopnosti",
      securingCloud: "Zabezpečenie vášho cloudu na",
      customTitle: "Potrebujete vlastné riešenie?",
      customSubtitle: "Náš tím dokáže prispôsobiť naše služby špecifickým bezpečnostným požiadavkám a potrebám súladu vašej organizácie.",
      customButton: "Kontaktujte náš tím",
      items: {
        offensive: {
          title: "Služby ofenzívnej bezpečnosti",
          description: "Od klasických penetračných testov a prispôsobených phishingových kampaní po RedTeam zákazky. Náš odborný tím simuluje reálne kybernetické útoky na identifikáciu zraniteľností a testovanie vašich obranných mechanizmov.",
          features: [
        ...
        cloud: {
          title: "Cloudová bezpečnosť",
          description: "Špecializované bezpečnostné hodnotenia pre prostredia AWS, Azure a GCP, zabezpečujúce, že vaša cloudová infraštruktúra spĺňa podnikové bezpečnostné štandardy a osvedčené postupy.",
          features: [
        ...
        defensive: {
          ...
          description: "Komplexná defenzívna bezpečnosť s nepretržitým monitorovaním, DevSecOps, správou aktív a proaktívnou reakciou na hrozby na ochranu vašej organizácie.",
          features: [
        ...
        etsm: {
          ...
          description: "OSINT monitoring, ktorý odhaľuje zraniteľnosti a poskytuje akčné poznatky prostredníctvom nepretržitého sledovania verejne dostupných údajov.",
          features: [
        ...
        training: {
          ...
          description: "Vybavuje zamestnancov zručnosťami na detekciu, hlásenie a reakciu na kybernetické hrozby, zabezpečujúc súlad a ochranu firemných aktív.",
          features: [
            "Školenie o súlade",
        ...
        compliance: {
          ...
          description: "Hodnotenia súladu v súlade s DORA, OSINT analýza a GAP analýza podľa CIS, NIST a predpisov EÚ na zabezpečenie, že vaša organizácia spĺňa všetky požiadavky prevádzkovej odolnosti.",
          features: [
            "DORA súlad",
        ...
        iam: {
          ...
          description: "IAM ako služba s využitím Okta, spravovaná cez Terraform a CI/CD pre bezpečnú, efektívnu správu identít a prístupov v celej vašej organizácii.",
          features: [
            "Okta SSO platforma",
        ...
        phishing: {
          ...
          description: "Otestujte povedomie zamestnancov realistickými simuláciami phishingu na zníženie rizík a posilnenie vašej kultúry kybernetickej bezpečnosti.",
          features: [
        ...
        siem: {
          ...
          description: "Monitorovanie bezpečnostných udalostí v reálnom čase s komplexnou analýzou logov a rýchlou detekciou a reakciou na potenciálne bezpečnostné incidenty.",
          features: [
            "Monitorovanie v reálnom čase",
  ...
  de: {
    ...
    contact: {
      ...
      heroSubtitle: "Unser Team von Sicherheitsexperten ist bereit, Ihnen beim Schutz Ihres Unternehmens zu helfen. Kontaktieren Sie uns für eine Beratung.",
      getInTouch: "Kontakt aufnehmen",
      getInTouchDesc: "Ob Sie eine Sicherheitsbewertung, Compliance-Beratung benötigen oder mehr über unsere Dienstleistungen erfahren möchten – wir sind für Sie da.",
      emailLabel: "E-Mail",
      phoneLabel: "Telefon",
      ...
      messageReceivedDesc: "Vielen Dank für Ihre Kontaktaufnahme. Einer unserer Sicherheitsberater wird Sie innerhalb von 24 Geschäftsstunden kontaktieren.",
      sendAnother: "Weitere Nachricht senden",
      privacyNote: "Mit dem Absenden dieses Formulars stimmen Sie unserer Datenschutzrichtlinie zu. Wir werden Ihre Daten niemals weitergeben.",
      form: {
    ...
    about: {
      ...
      heroSubtitle: "Gegründet von Sicherheitsveteranen mit jahrzehntelanger kombinierter Erfahrung, hat sich Red Patronus zu einem vertrauenswürdigen Partner für Unternehmensorganisationen entwickelt, die umfassende offensive Sicherheitsdienste suchen.",
      mission: {
      ...
      valuesSubtitle: "Unsere Grundwerte definieren, wie wir jedes Engagement und jede Beziehung mit unseren Kunden angehen.",
      values: {
        integrity: { title: "Integrität", description: "Wir arbeiten nach höchsten ethischen Standards und gewährleisten Kundenvertrauen und Vertraulichkeit in allen Engagements." },
        excellence: { title: "Exzellenz", description: "Unser Team strebt nach kontinuierlicher Verbesserung und bleibt neuen Bedrohungen und Angriffstechniken voraus." },
        collaboration: { title: "Zusammenarbeit", description: "Wir arbeiten als Erweiterung Ihres Teams und fördern Partnerschaften, die dauerhafte Sicherheitsverbesserungen bewirken." },
        confidentiality: { title: "Vertraulichkeit", description: "Kundendaten und Ergebnisse werden mit unternehmenstauglicher Sicherheit und strengen Zugriffskontrollen geschützt." },
      },
      teamTitle: "Erstklassiges Sicherheitsteam",
      teamDesc: "Unser Team besteht aus Sicherheitsexperten mit Hintergründen in Unternehmenssicherheit, Regierungsbehörden und führenden Technologieunternehmen. Jeder Berater verfügt über mehrere Branchenzertifizierungen und bringt praxisnahe Erfahrung in jedes Engagement ein.",
    ...
    caseStudies: {
      ...
      heroSubtitle: "Erfahren Sie, wie wir führenden Organisationen branchenübergreifend geholfen haben, Schwachstellen zu identifizieren, Compliance zu erreichen und ihre Sicherheitslage zu stärken.",
      stats: {
        clients: "Unternehmenskunden",
      ...
      studies: {
        financial: {
          ...
          challenge: "Eine große Globalbank benötigte eine umfassende Sicherheitsbewertung über 200+ Anwendungen vor einer großen digitalen Transformationsinitiative.",
          solution: "Durchführung eines phasenweisen Penetrationstest-Programms, Red-Team-Engagement und Überprüfung der Sicherheitsarchitektur über 12 Monate.",
          results: [
        ...
        healthcare: {
          ...
          challenge: "Ein regionaler Gesundheitsversorger mit 15 Krankenhäusern musste die Sicherheitslage bewerten und HIPAA-Compliance erreichen.",
          solution: "Durchführung von Netzwerk-Penetrationstests, Anwendungssicherheitsbewertung und Compliance-Lückenanalyse über alle Einrichtungen.",
          results: [
        ...
        technology: {
          ...
          challenge: "Ein Enterprise-SaaS-Unternehmen, das sich auf einen Börsengang vorbereitete, benötigte eine Sicherheitsvalidierung durch Dritte und SOC-2-Zertifizierung.",
          solution: "Umfassendes Sicherheitsprogramm einschließlich Cloud-Sicherheitsbewertung, API-Tests und kontinuierlicher Penetrationstests.",
          results: [
      ...
      testimonials: {
        t1: {
          quote: "Red Patronus hat unsere Sicherheitslage transformiert. Die Expertise und Professionalität ihres Teams hat unsere Erwartungen in jeder Phase übertroffen.",
          author: "Chief Information Security Officer",
          company: "Führendes Finanzdienstleistungsunternehmen",
        },
        t2: {
          quote: "Die Tiefe ihrer Bewertungen gab uns die Zuversicht, dass wir wirklich auf reale Bedrohungen vorbereitet waren. Außergewöhnliche Arbeit.",
          author: "VP Engineering",
          company: "Enterprise-Technologieunternehmen",
        },
      },
      certificationsTitle: "Branchenzertifizierungen & Partnerschaften",
      certificationsSubtitle: "Unser Team verfügt über branchenführende Zertifizierungen und pflegt Partnerschaften mit wichtigen Sicherheitsorganisationen.",
      certifications: {
      ...
      ctaSubtitle: "Kontaktieren Sie uns, um zu besprechen, wie wir die Sicherheitslage Ihrer Organisation stärken können.",
      ctaButton: "Bewertung starten",
    },
    servicesPage: {
      heroLabel: "Unsere Dienstleistungen",
      heroTitle: "Enterprise Sicherheitslösungen",
      heroSubtitle: "Wir liefern fachkundige digitale Lösungen nach dem DORA-Gesetz (Digital Operational Resilience Act). Von Schwachstellenbewertungen bis hin zu fortschrittlichem Bedrohungsmonitoring – alle unsere Dienste sind auf die höchsten regulatorischen Standards ausgelegt.",
      keyCapabilities: "Kernkompetenzen",
      securingCloud: "Absicherung Ihrer Cloud auf",
      customTitle: "Individuelle Lösung benötigt?",
      customSubtitle: "Unser Team kann unsere Dienstleistungen an die spezifischen Sicherheitsanforderungen und Compliance-Bedürfnisse Ihrer Organisation anpassen.",
      customButton: "Unser Team kontaktieren",
      items: {
        offensive: {
          title: "Offensive Sicherheitsdienste",
          description: "Von klassischen Penetrationstests und maßgeschneiderten Phishing-Kampagnen bis hin zu RedTeam-Engagements. Unser Expertenteam simuliert reale Cyberangriffe, um Schwachstellen zu identifizieren und Ihre Abwehr zu testen.",
          features: [
        ...
        cloud: {
          title: "Cloud-Sicherheit",
          description: "Spezialisierte Sicherheitsbewertungen für AWS-, Azure- und GCP-Umgebungen, die sicherstellen, dass Ihre Cloud-Infrastruktur die Sicherheitsstandards und Best Practices für Unternehmen erfüllt.",
          features: [
        ...
        defensive: {
          ...
          description: "Umfassende defensive Sicherheit mit kontinuierlichem Monitoring, DevSecOps, Asset-Management und proaktiver Bedrohungsreaktion zum Schutz Ihrer Organisation.",
          features: [
            "Security Operations Center (SOC)",
        ...
        etsm: {
          ...
          description: "OSINT-gestütztes Monitoring, das Schwachstellen aufdeckt und umsetzbare Erkenntnisse durch kontinuierliche Überwachung öffentlich verfügbarer Daten liefert.",
          features: [
        ...
        training: {
          ...
          description: "Stattet Mitarbeiter mit den Fähigkeiten aus, Cyberbedrohungen zu erkennen, zu melden und darauf zu reagieren, und gewährleistet Compliance und den Schutz von Unternehmenswerten.",
          features: [
            "Compliance-Schulung",
        ...
        compliance: {
          ...
          description: "DORA-konforme Compliance-Bewertungen, OSINT-Analyse und GAP-Analyse nach CIS, NIST und EU-Vorschriften, um sicherzustellen, dass Ihre Organisation alle Anforderungen an die operative Resilienz erfüllt.",
          features: [
            "DORA-Compliance",
        ...
        iam: {
          ...
          description: "IAM als Service mit Okta, verwaltet über Terraform und CI/CD für sicheres, effizientes Identitäts- und Zugriffsmanagement in Ihrer gesamten Organisation.",
          features: [
            "Okta SSO-Plattform",
            "Active-Directory-Integration",
        ...
        phishing: {
          title: "Phishing-Simulation",
          description: "Testen Sie das Bewusstsein der Mitarbeiter mit realistischen Phishing-Simulationen, um Risiken zu reduzieren und Ihre Cybersicherheitskultur zu stärken.",
          features: [
        ...
        siem: {
          title: "SIEM & Audit-Logging",
          description: "Echtzeit-Überwachung von Sicherheitsereignissen mit umfassender Log-Analyse und schneller Erkennung und Reaktion auf potenzielle Sicherheitsvorfälle.",
          features: [
            "Echtzeit-Monitoring",
