...
const translations: Record<Language, Record<string, any>> = {
  ...
  fr: {
    ...
    hero: {
      ...
      subtitle: "Protégez vos actifs numériques avec des services de sécurité de pointe, des tests d'intrusion et des solutions conformes à DORA. Votre partenaire de confiance en cybersécurité.",
      cta: "Commencer",
      secondaryCta: "Nos services",
    },
    services: {
      title: "Nos services de sécurité",
      subtitle: "Des solutions complètes de cybersécurité conçues pour protéger votre organisation contre les menaces émergentes tout en garantissant la conformité DORA.",
      viewAll: "Voir tous les services",
      learnMore: "En savoir plus",
      offensive: {
        title: "Sécurité offensive",
        description: "Tests de sécurité proactifs incluant tests d'intrusion, exercices de red team et évaluations de vulnérabilités.",
      },
      defensive: {
        title: "Sécurité défensive",
        description: "Surveillance de sécurité 24/7, réponse aux incidents et détection des menaces pour protéger votre infrastructure.",
      },
      cloud: {
      ...
      consulting: {
        ...
        description: "Services de conseil stratégique en sécurité pour renforcer la posture de sécurité de votre organisation.",
      },
      training: {
    ...
    ai: {
      ...
      subtitle: "Exploitez la puissance de l'intelligence artificielle pour détecter les menaces plus rapidement, automatiser les tests de sécurité et garder une longueur d'avance sur les cyberattaques sophistiquées.",
      cta: "Découvrir les solutions IA",
      features: {
        pentest: {
          title: "Tests d'intrusion IA",
          description: "Tests d'intrusion automatisés et intelligents qui sondent en continu vos systèmes, identifiant les vulnérabilités avec une rapidité et une précision dépassant les tests manuels.",
        },
        threatIntel: {
          title: "Renseignement sur les menaces IA",
          description: "Renseignement sur les menaces en temps réel propulsé par l'apprentissage automatique, analysant les données mondiales pour prédire et prévenir les attaques.",
        },
        autoResponse: {
          title: "Réponse automatisée aux incidents",
          description: "Réponse aux incidents pilotée par l'IA qui détecte, contient et corrige les incidents de sécurité en quelques secondes, minimisant les dommages et les temps d'arrêt.",
        },
        continuous: {
          title: "Surveillance continue de la sécurité",
          description: "Surveillance 24/7 propulsée par l'IA qui apprend le comportement de référence de votre environnement et signale instantanément les anomalies et les menaces potentielles.",
        },
      },
    },
    trust: {
      ...
      testimonial: {
        quote: "Red Patronus a fourni des services exceptionnels d'évaluation de la sécurité pour notre infrastructure cloud. Leurs tests d'intrusion approfondis et leurs rapports clairs nous ont aidés à renforcer considérablement notre posture de sécurité dans toutes nos opérations d'assurance.",
    ...
    cta: {
      ...
      subtitle: "Contactez dès aujourd'hui nos experts en sécurité et découvrez comment nous pouvons protéger votre organisation contre les cybermenaces.",
      button: "Planifier une consultation",
    },
    footer: {
      description: "Solutions de cybersécurité pour entreprises protégeant les organisations à travers l'Europe. Services de sécurité conformes à DORA en qui vous pouvez avoir confiance.",
      services: "Services",
      company: "Entreprise",
    ...
    contact: {
      ...
      heroSubtitle: "Notre équipe d'experts en sécurité est prête à vous aider à protéger votre entreprise. Contactez-nous pour planifier une consultation.",
      getInTouch: "Entrer en contact",
      getInTouchDesc: "Que vous ayez besoin d'une évaluation de sécurité, de conseils en conformité ou que vous souhaitiez en savoir plus sur nos services, nous sommes là pour vous aider.",
      emailLabel: "E-mail",
      ...
      messageReceivedDesc: "Merci de nous avoir contactés. L'un de nos consultants en sécurité vous contactera sous 24 heures ouvrées.",
      sendAnother: "Envoyer un autre message",
      privacyNote: "En soumettant ce formulaire, vous acceptez notre politique de confidentialité. Nous ne partagerons jamais vos informations.",
      form: {
        name: "Nom complet",
      ...
      info: {
        ...
        description: "Prêt à discuter de vos besoins en cybersécurité ? Notre équipe d'experts est là pour vous aider à protéger vos actifs numériques.",
        email: "Écrivez-nous",
        call: "Appelez-nous",
    ...
    about: {
      ...
      heroSubtitle: "Fondé par des vétérans de la sécurité avec des décennies d'expérience combinée, Red Patronus est devenu un partenaire de confiance pour les organisations recherchant des services complets de sécurité offensive.",
      mission: {
        title: "Notre mission",
        description: "Fournir des solutions de cybersécurité de classe mondiale qui protègent les organisations contre les menaces émergentes tout en garantissant la conformité réglementaire.",
      ...
      vision: {
        title: "Notre vision",
        description: "Être le principal partenaire en cybersécurité pour les entreprises en Europe, définissant la norme d'excellence en sécurité.",
      },
      ...
      valuesSubtitle: "Nos valeurs fondamentales définissent notre approche de chaque mission et relation avec nos clients.",
      values: {
        integrity: { title: "Intégrité", description: "Nous opérons selon les normes éthiques les plus élevées, garantissant la confiance des clients et la confidentialité dans toutes les missions." },
        excellence: { title: "Excellence", description: "Notre équipe vise l'amélioration continue, restant en avance sur les menaces et techniques d'attaque émergentes." },
        collaboration: { title: "Collaboration", description: "Nous travaillons comme une extension de votre équipe, favorisant des partenariats qui apportent des améliorations durables en matière de sécurité." },
        confidentiality: { title: "Confidentialité", description: "Les données et résultats des clients sont protégés par une sécurité de niveau entreprise et des contrôles d'accès stricts." },
      },
      teamTitle: "Une équipe de sécurité de classe mondiale",
      teamDesc: "Notre équipe est composée de professionnels de la sécurité avec des parcours dans la sécurité d'entreprise, les agences gouvernementales et les entreprises technologiques leaders. Chaque consultant détient plusieurs certifications sectorielles et apporte une expérience concrète à chaque mission.",
      ...
      ctaSubtitle: "Discutons de la manière dont Red Patronus peut aider à renforcer la posture de sécurité de votre organisation.",
      ctaButton: "Contactez-nous dès aujourd'hui",
    },
    caseStudies: {
      heroLabel: "Études de cas",
      heroTitle: "Résultats éprouvés pour les clients entreprises",
      heroSubtitle: "Découvrez comment nous avons aidé des organisations de premier plan dans divers secteurs à identifier des vulnérabilités, atteindre la conformité et renforcer leur posture de sécurité.",
      stats: {
        clients: "Clients entreprises",
      ...
      studies: {
        financial: {
          ...
          challenge: "Une grande banque mondiale avait besoin d'une évaluation complète de la sécurité sur 200+ applications avant une grande initiative de transformation numérique.",
          solution: "Programme de tests d'intrusion par phases, engagement red team et revue de l'architecture de sécurité sur 12 mois.",
          results: [
        ...
        healthcare: {
          ...
          challenge: "Un fournisseur régional de soins de santé avec 15 hôpitaux devait évaluer sa posture de sécurité et atteindre la conformité HIPAA.",
          solution: "Tests d'intrusion réseau, évaluation de la sécurité des applications et analyse des écarts de conformité dans tous les établissements.",
          results: [
        ...
        technology: {
          ...
          challenge: "Une entreprise SaaS préparant son introduction en bourse avait besoin d'une validation de sécurité par un tiers et d'une certification SOC 2.",
          solution: "Programme de sécurité complet incluant évaluation de la sécurité cloud, tests d'API et tests d'intrusion continus.",
          results: [
      ...
      testimonials: {
        t1: {
          quote: "Red Patronus a transformé notre posture de sécurité. L'expertise et le professionnalisme de leur équipe ont dépassé nos attentes à chaque étape.",
          author: "Directeur de la sécurité des systèmes d'information",
          company: "Société leader en services financiers",
        },
        t2: {
          quote: "La profondeur de leurs évaluations nous a donné l'assurance que nous étions vraiment prêts pour les menaces réelles. Travail exceptionnel.",
          author: "VP Ingénierie",
          company: "Entreprise technologique",
        },
      },
      certificationsTitle: "Certifications et partenariats sectoriels",
      certificationsSubtitle: "Notre équipe détient des certifications leaders du secteur et entretient des partenariats avec les principales organisations de sécurité.",
      certifications: {
      ...
      ctaSubtitle: "Contactez-nous pour discuter de la manière dont nous pouvons aider à renforcer la posture de sécurité de votre organisation.",
      ctaButton: "Démarrer votre évaluation",
    },
    servicesPage: {
      heroLabel: "Nos services",
      heroTitle: "Solutions de sécurité pour entreprises",
      heroSubtitle: "Nous fournissons des solutions numériques expertes selon le règlement DORA (Digital Operational Resilience Act). Des évaluations de vulnérabilités au monitoring avancé des menaces, tous nos services sont conçus pour répondre aux normes réglementaires les plus strictes.",
      keyCapabilities: "Capacités clés",
      securingCloud: "Sécuriser votre cloud sur",
      customTitle: "Besoin d'une solution sur mesure ?",
      customSubtitle: "Notre équipe peut adapter nos services aux exigences spécifiques de sécurité et de conformité de votre organisation.",
      customButton: "Contacter notre équipe",
      items: {
        offensive: {
          title: "Services de sécurité offensive",
          description: "Des tests d'intrusion classiques et campagnes de phishing personnalisées aux engagements Red Team. Notre équipe d'experts simule des cyberattaques réelles pour identifier les vulnérabilités et tester vos défenses.",
          features: [
        ...
        cloud: {
          title: "Sécurité cloud",
          description: "Évaluations de sécurité spécialisées pour les environnements AWS, Azure et GCP, garantissant que votre infrastructure cloud répond aux normes de sécurité et meilleures pratiques d'entreprise.",
          features: [
        ...
        defensive: {
          ...
          description: "Sécurité défensive complète avec surveillance continue, DevSecOps, gestion des actifs et réponse proactive aux menaces pour protéger votre organisation.",
          features: [
        ...
        etsm: {
          ...
          description: "Surveillance OSINT qui révèle les vulnérabilités et fournit des informations exploitables grâce à une surveillance continue des données publiquement disponibles.",
          features: [
        ...
        training: {
          ...
          description: "Dote les employés des compétences pour détecter, signaler et répondre aux cybermenaces, garantissant la conformité et protégeant les actifs de l'entreprise.",
          features: [
        ...
        compliance: {
          ...
          description: "Évaluations de conformité alignées sur DORA, analyse OSINT et analyse des écarts selon CIS, NIST et les réglementations de l'UE pour garantir que votre organisation répond à toutes les exigences de résilience opérationnelle.",
          features: [
            "Conformité DORA",
        ...
        iam: {
          ...
          description: "IAM en tant que service utilisant Okta, géré via Terraform et CI/CD pour une gestion sécurisée et efficace des identités et des accès dans toute votre organisation.",
          features: [
            "Plateforme SSO Okta",
        ...
        phishing: {
          ...
          description: "Testez la sensibilisation des employés avec des simulations de phishing réalistes pour réduire les risques et renforcer votre culture de cybersécurité.",
          features: [
        ...
        siem: {
          ...
          description: "Surveillance en temps réel des événements de sécurité avec analyse complète des journaux et détection et réponse rapides aux incidents de sécurité potentiels.",
          features: [
            "Monitoring en temps réel",
